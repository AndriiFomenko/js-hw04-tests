/*
 ...
 `modifyFunction` має повертати нову функцію, яка при виклику з будь-яким числовим аргументом викликає передану функцію `originalFunc` з цим аргументом і множить отриманий результат на `multiplier`.

 Наприклад, якщо передана функція повертає квадрат вхідного аргументу, і `multiplier` дорівнює 3, 
 то повернута функція має повертати квадрат вхідного аргументу, помножений на 3.
*/
...
// console.log('Original function output for 4:', originalFunction(4)) // Має вивести 16
// console.log('Modified function output for 4:', modifiedFunc(4)) // Має вивести 48 (16 * 3)
...
/*
 ...
 `originalFunction(4)` має повернути 16 (4 * 4), а `modifiedFunc(4)` має повернути 48, оскільки 16 (результат переданої функції) множиться на 3 (множник у `modifyFunction`).
*/
