...
outerFunction має повертати функцію innerFunction, яка також приймає один аргумент.

innerFunction має повертати функцію deepInnerFunction, яка також приймає один аргумент.

deepInnerFunction має перемножувати всі передані аргументи (по одному з кожної функції) і повертати результат цієї операції.
...
// console.log(result) // Має повернути 24 (2*3*4)
...
/*
 ...
 Всередині deepInnerFunction використовуються аргументи arg1, arg2 та arg3. Цікаво, що deepInnerFunction має доступ до аргументів arg1 та arg2, незважаючи на те, що вони знаходяться в різних областях видимості. Це можливо завдяки замиканням в JavaScript.
